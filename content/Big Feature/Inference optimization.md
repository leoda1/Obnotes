 ...
 **核心工作 1：deepseek v3.2 使用 flag 系列完成vllm PD 分离推理**
 ...
 - [x] 学习 mooncake 源码和 vllm 的不同 connector 的 kv cache 调度逻辑，拆分 flagcx connector 开发方案 ✅ 2026-03-31
     - [x] nixl 源码整体实现[[0. nixl research]] ✅ 2026-03-31
     - [ ] Nccl_connector->flagcx_connector 优化，放在vllm-plugin-fl；Nccl engine->flagcx engine，和mooncake性能对齐；
     - [ ] mooncake 源码整体实现
